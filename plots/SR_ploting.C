...
//already commented 
  ...
  */ 
  ...
  histo_ZNuNuG->Scale(int_lumi*scale_factor*frac_above0p5*2.116e-01/636354); // LO sample entries and xsec
  ...
  */
  ...
  if(int_ZNuNuG > 0.0){
    err_ZNuNuG = sqrt(int_ZNuNuG*int_ZNuNuG*((photon_scale_factor_unc*photon_scale_factor_unc)+(2.116e-01*int_lumi*scale_factor*frac_above0p5-int_ZNuNuG)/(636354*int_ZNuNuG))+(qcdscaleerr_ZNuNuG*qcdscaleerr_ZNuNuG)+(jeserr_ZNuNuG*jeserr_ZNuNuG)+(peserr_ZNuNuG*peserr_ZNuNuG)+(pdferr_ZNuNuG*pdferr_ZNuNuG)+(straighterr_ZNuNuG*straighterr_ZNuNuG)+(twistederr_ZNuNuG*twistederr_ZNuNuG)+(gammaerr_ZNuNuG*gammaerr_ZNuNuG));
    if(histname == "Photon_Et_range_24"){
  ...
  */
  ...
  histo_GJets_40to100->Scale(int_lumi*scale_factor*frac_above0p5*18700.0/1947013);
  histo_GJets_40to100_JESUp->Scale(int_lumi*scale_factor*frac_above0p5*18700.0/1947013);
  histo_GJets_40to100_JESDown->Scale(int_lumi*scale_factor*frac_above0p5*18700.0/1947013);
  histo_GJets_40to100_PESUp->Scale(int_lumi*scale_factor*frac_above0p5*18700.0/1947013);
  histo_GJets_40to100_PESDown->Scale(int_lumi*scale_factor*frac_above0p5*18700.0/1947013);
  histo_GJets_100to200->Scale(int_lumi*scale_factor*frac_above0p5*5034.0/9939048);
  histo_GJets_100to200_JESUp->Scale(int_lumi*scale_factor*frac_above0p5*5034.0/9939048);
  histo_GJets_100to200_JESDown->Scale(int_lumi*scale_factor*frac_above0p5*5034.0/9939048);
  histo_GJets_100to200_PESUp->Scale(int_lumi*scale_factor*frac_above0p5*5034.0/9939048);
  histo_GJets_100to200_PESDown->Scale(int_lumi*scale_factor*frac_above0p5*5034.0/9939048);
  ...
  if(int_GJets_40to100>0.0)
    err_GJets_40to100 = sqrt(int_GJets_40to100*int_GJets_40to100*((photon_scale_factor_unc*photon_scale_factor_unc)+(18700.0*int_lumi*scale_factor*frac_above0p5-int_GJets_40to100)/(1947013*int_GJets_40to100))+(jeserr_GJets_40to100*jeserr_GJets_40to100)+(peserr_GJets_40to100*peserr_GJets_40to100));
  if(int_GJets_100to200>0.0)
    err_GJets_100to200 = sqrt(int_GJets_100to200*int_GJets_100to200*((photon_scale_factor_unc*photon_scale_factor_unc)+(5034.0*int_lumi*scale_factor*frac_above0p5-int_GJets_100to200)/(9939048*int_GJets_100to200))+(jeserr_GJets_100to200*jeserr_GJets_100to200)+(peserr_GJets_100to200*peserr_GJets_100to200));
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    if(int_bin_40to100>0.0)
      err_bin_40to100 = int_bin_40to100*sqrt((18700.0*int_lumi*scale_factor*frac_above0p5-int_bin_40to100)/(1947013*int_bin_40to100));
    if(int_bin_100to200>0.0)
      err_bin_100to200 = int_bin_100to200*sqrt((5034.0*int_lumi*scale_factor*frac_above0p5-int_bin_100to200)/(9939048*int_bin_100to200));
  ...
  //DEBUG
   cout<<"GJets got"<<endl;
   if (histname == "Photon_Et_range_24"){
     cout<<"nevents_passing_40to100: "<<(int_GJets_40to100*1947013/(int_lumi*scale_factor*frac_above0p5*18700.0))<<", nevent_total_40to100: "<<4269126<<endl;
     cout<<"nevents_passing_100to200: "<<(int_GJets_100to200*9939048/(int_lumi*scale_factor*frac_above0p5*5034.0))<<", nevent_total_100to200: "<<5131808<<endl;
     ...
     cout<<"int_GJets_40to100: "<<int_GJets_40to100<<"+-"<<err_GJets_40to100<<"(tot), "<<"+-"<<(int_GJets_40to100*sqrt((18700.0*int_lumi*scale_factor*frac_above0p5-int_GJets_40to100)/(1947013*int_GJets_40to100)))<<"(stat)"<<endl;
     cout<<"int_GJets_100to200: "<<int_GJets_100to200<<"+-"<<err_GJets_100to200<<"(tot), "<<"+-"<<(int_GJets_100to200*sqrt((5034.0*int_lumi*scale_factor*frac_above0p5-int_GJets_100to200)/(9939048*int_GJets_100to200)))<<"(stat)"<<endl;
  ...
  */
  ...
  TH1F *histo_allbackgrounds = (TH1F*)histo_elefake->Clone("histo_allbackgrounds");
