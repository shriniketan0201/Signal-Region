  ...
  for(int p=0;p<nPho;p++)
    {
      ...
      //      bool kinematic = uncorrectedPhoEt > phoPtCut  && fabs((*phoSCEta)[p])<phoEtaCut;  //For Barrel
      bool kinematic = uncorrectedPhoEt > phoPtCut  && fabs((*phoSCEta)[p])<2.5 && fabs((*phoSCEta)[p])>1.566;  //For Endcap
