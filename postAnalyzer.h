...
// Tue Feb  8 20:43:05 2022 by ROOT version 6.24/06
// from TTree eventTree/event tree for analysis
// found on file: Data_MET2018B_383.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   */
   TH1F *h_photon_Et[45], *h_photon_Et_range[45], *h_photon_eta[45], *h_photon_SCEta[45],*h_PTMET[45],*h_nVtx[45];
   TH1F *h_photon_phi[45], *h_photon_SCPhi[45], *h_photon_IDbit[45];
   TH1F *h_dPhijetmet_min,*h_dPhijetmet_min_first4,*h_HT;
   TH2F *h_HTMET,*h_njetMET;


   TH1F *h_pfMET[45], *h_dPhi[45],*h_Mt[45];
   TH1F *h_pfMET_300[45], *h_nvtx[45];
   TH1F *h_nJet[45], *h_leadingJetPt[45], *h_leadingJetPt_300[45], *h_leadingJetEta[45];
   TH2F *h_phoIEtaIPhi[45];

   TH1F *h_min_dphijetmet[45], *h_pfMETsumEt[45], *h_METoverSqrtSumEt_extended[45], *h_METoverSqrtSumEt[45];
 ...
 // Declaration of leaf types
   ...
   virtual void fillHistos(int histoNumber, double event_weight, int index, std::vector<int> jets);
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Data_MET2018B_383.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Data_MET2018B_383.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("Data_MET2018B_383.root:/phoJetNtuplizer");
